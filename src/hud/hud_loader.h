...
//
// The `composites` block is recognized and applied for the engine-owned
// bars, inventory, minimap, joystick, pickup bar, and display messages.
// The `preset` string is stored for preset-specific HUD behavior.
//
