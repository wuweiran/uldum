...
CAMERA_FIELD_TARGET_DISTANCE = 0
CAMERA_FIELD_ANGLE_OF_ATTACK = 2
CAMERA_FIELD_FIELD_OF_VIEW   = 3
CAMERA_FIELD_ROTATION        = 5
CAMERA_FIELD_ZOFFSET         = 6
...
EVENT_GLOBAL_UNIT_REVIVED    = "global_unit_revived"
...
EVENT_GLOBAL_CONSTRUCTION_START    = "global_construction_start"
EVENT_GLOBAL_CONSTRUCTION_FINISH   = "global_construction_finish"
...
EVENT_UNIT_REVIVED         = "unit_revived"
...
EVENT_UNIT_CONSTRUCTION_START   = "unit_construction_start"
EVENT_UNIT_CONSTRUCTION_FINISH  = "unit_construction_finish"
